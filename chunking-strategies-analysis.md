...
| *Unknown / General PDF* | `NarrativeDocumentStrategy` | 750 | 100 | 450 |
...
8. **Carry-Forward Merging**: `merge_small_blocks` groups adjacent blocks until they hit `target_tokens`. Any lingering orphans < 40 tokens (`CARRY_FORWARD_MAX_TOKENS`) are carried into the *next* section to prevent isolated, meaningless chunks.
...
**Interview Question:** *"Why did you use this specific chunking strategy for bank statements?"*
...
**Interview Question:** *"Why does your Bank Policy chunker have 0 token overlap and custom exception gluing?"*
...
**Interview Question:** *"Why use such a small chunk size for Identity Documents?"*
